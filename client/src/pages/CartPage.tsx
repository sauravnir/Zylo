  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-background">
        <main className="max-w-5xl mx-auto px-4 md:px-20 py-32 md:pt-40">
          <h1 className="text-center text-h3 text-main uppercase font-medium tracking-widest mb-12 pb-6">
            {totalItem > 0 && `YOUR CART (${totalItem})`}
          </h1>
          {storeValue.length > 0 ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start justify-center">
              ...
              <aside className="lg:col-span-6 bg-muted/10 p-8 sticky top-32">
                <h2 className="text-sm uppercase tracking-widest text-main mb-8 font-bold">
                  Order Summary
                </h2>

                <div className="space-y-2 border-b border-main pb-0 mb-6">
                ...
                <div className="flex flex-row items-center justify-center pt-4">
                  <span className="text-main/60 text-sm text-center underline leading-tight tracking-normal">
